...
public class FontSelectorDialog extends Dialog<Font> {
    ...
    private static class FontPanel extends GridPane {
        ...
        public FontPanel() {
            ...
            ChangeListener<Object> sampleRefreshListener = (arg0, arg1, arg2) -> refreshSample();

            fontListView.selectionModelProperty().get().selectedItemProperty().addListener((arg0, arg1, arg2) -> {
                String fontFamily = listSelection(fontListView);
                styleListView.setItems(FXCollections.observableArrayList(getFontStyles(fontFamily)));
                refreshSample();
            });
